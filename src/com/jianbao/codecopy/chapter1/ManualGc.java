...
public class ManualGc {
    public static void main(String[] args)throws Exception{
        ...
        System.out.println("【3】垃圾产生后的内存信息：FreeMemory = "+runtime.freeMemory());
        runtime.gc();
        System.out.println("【4】GC调用后的内存信息：MaxMemory = "+runtime.maxMemory());
        System.out.println("【5】GC调用的内存信息：TotalMemory = "+runtime.totalMemory());
        System.out.println("【6】GC调用后的内存信息：FreeMemory = "+runtime.freeMemory());
    }
}
